...
if ( $attachment_ids && $product->get_image_id() ) {
    foreach ( $attachment_ids as $key => $attachment_id ) {
        ...
        echo apply_filters(
            ...
            project_theme_add_swiper_class_to_product_gallery_item(
                project_theme_add_fancybox_to_product_gallery_item(
                    wc_get_gallery_image_html( $attachment_id, true, $key ),
                    $gallery_lightbox_id
                )
            ),
            $attachment_id
