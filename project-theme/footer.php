...
?>
    <footer class="footer">
        <div class="footer-fon">
            <picture>
                <source media="(max-width: 575px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/footer-fon-mobile.png">
                <img
                        loading="eager"
                        decoding="async"
                        src="<?php echo get_template_directory_uri(); ?>/assets/img/footer-fon.png" alt="">
            </picture>
        </div>
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-auto col-sm-6 col-md-auto d-flex d-md-block">
                    ...
                    if( $social_media ) : ?>
                        <div class="menu wrap-pay-img mt-auto w100">
